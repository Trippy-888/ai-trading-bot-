...
def format_trading_message(data):
    ...
    try:
        ...
        # Build the message
        message = f"""🚨 <b>SMC AI SNIPER {action} SIGNAL</b> 🚨

{signal_emoji} <b>Ticker:</b> {ticker}
{direction_emoji} <b>Entry:</b> ${price}
🛡️ <b>Stop Loss:</b> ${sl}
...
{confidence_emoji} <b>Confidence:</b> {confidence}

💎 <b>Trap Zone:</b> {"✅" if trap_zone else "❌"}
📈 <b>Volume Surge:</b> {"✅" if volume_surge else "❌"}
📍 <b>ATR:</b> {atr}

⏰ <b>Time:</b> {timestamp}

<i>Generated by SMC AI Sniper Alert Bot</i>"""
